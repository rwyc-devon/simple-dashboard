...
function widget_html_load() {
	...
	$normload=widget_normload();
	return "<div class='has-bar' data-icon='&#9729'><span class='bargraph' style='width:$normload%'></span><span class='percent'>$load</span></div>"; #TODO: there's gotta be something better than a cloud for load avg.
}
function widget_normload()
{
	global $load_cores;
	if(isset($load_cores)) {
...
function widget_status_load() {
	...
	global $load_good;
	global $load_cores;
	$normload=widget_normload()/$load_cores;
